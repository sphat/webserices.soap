...
CREATE TABLE commande (
	 id bigint NOT NULL,
	 cmd_id character varying(15),
	 date_livraison date,
	 commande_status character varying(255)
);
...
ALTER TABLE ONLY commande_article
    ADD CONSTRAINT commande_article_pkey PRIMARY KEY (id);
    
ALTER TABLE ONLY commande_article
    ADD CONSTRAINT wine_commande_article_fkey FOREIGN KEY (wine_id) REFERENCES wine(id);
    
ALTER TABLE ONLY commande_article
    ADD CONSTRAINT commande_id_commande_article_fkey FOREIGN KEY (commande_id) REFERENCES commande(id);
